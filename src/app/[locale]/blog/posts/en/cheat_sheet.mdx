...
image: "/images/gallery/cheat_bg.png"
...
<CodeBlock
  ...
  codeInstances={[
    {
      code: "cht.sh --standalone-install",
      label: "Next.js",
      language: "bash",
    },
  ]}
  copyButton
/>
During the installation process, cheat.sh and its data sources will be installed
locally.

By default `~/.cheat.sh` is used as the installation
directory.

![cheat.sh standalone installation](/images/gallery/cheat.png)
